        ...
        if (err) {
          if (fn.err) {
            if (fn instanceof Router) {
              fn.route.apply(fn,[name, err].concat(args).concat(next));
            }
            else {
              fn.apply(fn, [err].concat(args).concat(next));
            }
          }
          else {
            next(err);
          ...
          if (fn.err) {
            ...
            if (fn instanceof Router) {
              fn.route.apply(fn,[name].concat(args).concat(next));
            }
            else {
